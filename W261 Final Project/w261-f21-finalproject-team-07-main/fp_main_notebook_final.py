...
# MAGIC 
# MAGIC - <a href="$./starter_nb_fp_KF_v9">Weather Dataset: Integrated Surface Data (ISD)</a>
# MAGIC   - Aviation Support Tables - Master Coordinate
# MAGIC   
# MAGIC -  <a href="$./starter_nb_fp_AD_v5">Joined Dataset of the weather and airlines data</a>
...
displayHTML("""<iframe src="https://drive.google.com/file/d/1b9vHHoowLb17ODQJK_iltTH6CUsKWVHZ/preview" width="640" height="480" allow="autoplay"></iframe>""")
